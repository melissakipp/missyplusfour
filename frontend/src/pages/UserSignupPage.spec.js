...
describe('UserSignupPage', () => {
  ...
  describe('Layout', () => {
    ...
    it('has submit type for form button', () => {
      const { container } = render(<UserSignupPage />);
      const button = container.querySelector('button');
  ...
  // New test group - Integration test
  describe('Interactions', () => {
    ...
    it('does not throw except when clicking the button when actions not provide in props', () => {
      setupForSubmit();
  ...
  it('enables the signup button when password and repeat password have same value', () => {
    ...
    // TODO: Not sure way this test is falling
